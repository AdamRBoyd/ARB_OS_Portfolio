...
export default function useFakeSystemStatus() {
    const [status, setStatus] = useState(() => ({
        ...
        power: {
            charging: pick([true, false]),
            level: pick([42, 58, 73, 86, 96]),
        },
    ...
    const api = useMemo(() => {
        const toggleMute = () =>
            setStatus((s) => ({
                ...s,
                sound: { ...s.sound, muted: !s.sound.muted },
            }));

        const toggleCharging = () =>
            setStatus((s) => ({
                ...s,
                power: { ...s.power, charging: !s.power.charging },
            }));
        ...
        const cycleWifi = () =>
            setStatus((s) => ({
                ...
                wifi: {
                    ...s.wifi,
                    level: s.wifi.level === 4 ? 1 : s.wifi.level + 1,
                },
            }));
