...
const WorkoutLogWindow = () => {
    ...
    const onSubmit = (e) => {
        ...
        if (isEditing) {
            ...
            setWorkouts((prev) => [
                ...prev,
                { ...newWorkout, id: crypto.randomUUID(), duration },
            ]);
        }
                    ...
                    <ListBody>
                        {sortedWorkouts.map((w) => (
                            <WorkoutListLine key={w.id}>
                                <WorkoutListItemType title={w.type}>
                                    {w.type}
                                </WorkoutListItemType>
                                <WorkoutListItemDuration title={w.duration}>
                                    {w.duration}
                                </WorkoutListItemDuration>
                                <WorkoutListItemDate title={w.date}>
                                    {w.date}
                                </WorkoutListItemDate>
